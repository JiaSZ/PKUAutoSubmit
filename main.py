...
if __name__ == '__main__':
    ...
    parser.add_argument('--reason', type=str, help='出校原因, eg. 吃饭', default='入校项目讨论，住宿校外')
    parser.add_argument('--destination', type=str, help='出校目的地, eg. 北京', default='北京')
    parser.add_argument('--track', type=str, help='出校轨迹, eg. 畅春园食堂', default='北京市海淀区燕园街道畅春园北门超市发旁产业中心')
